    ...
    <div className="relative min-h-screen bg-bg overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-primary">Category</p>
        ...
        {loading ? (
          ...
          <div className="animate-fade-in-up text-center py-32">
            ...
            <p className="text-text-muted">Check back later for new arrivals</p>
          </div>
        ) : (
                ...
                <div className="relative overflow-hidden">
                  ...
                  {product.subcategory && (
                    <div className="absolute top-3 left-3">
                      <span className="bg-bg-card/90 backdrop-blur-sm text-primary text-xs font-semibold px-3 py-1 rounded-full border border-primary/20">
                        {product.subcategory}
                      </span>
                    </div>
                  )}
