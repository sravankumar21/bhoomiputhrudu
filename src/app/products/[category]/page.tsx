    ...
    <div className="relative min-h-screen bg-ivory overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex items-center gap-4 mb-10 animate-fade-in-up">
          ...
          <div>
            <p className="uppercase tracking-[0.2em] text-gold text-xs font-semibold">Category</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-32 animate-fade-in-up">
            ...
            <p className="text-charcoal-muted">Check back later for new arrivals</p>
          </div>
        ) : (
                ...
                <div className="relative overflow-hidden">
                  ...
                  {product.subcategory && (
                    <div className="absolute top-3 left-3">
                      <span className="bg-white/90 backdrop-blur-sm text-green-primary text-xs font-semibold px-3 py-1 rounded-full border border-green-primary/20">
                        {product.subcategory}
                      </span>
                    </div>
                  )}
